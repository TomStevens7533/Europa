...
{
	m_pChunkMesh = GetAttachedGameObject()->GetComponent<Eu::MeshComponent>();
	m_pChunkMeshRenderer = GetAttachedGameObject()->GetComponent<Eu::MeshRenderComponent>();
...
bool ChunkMeshComponent::AddFace(glm::vec3 ChunPos, glm::vec3 BlockPos, Faces dir, BlockTypes blockType)
{
